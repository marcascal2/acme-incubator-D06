...
@Service
public class AdministratorTechnologyRecordsDeleteService implements AbstractDeleteService<Administrator, TechnologyRecord> {
	...
	//AbstractDeleteService<Administrator, TechnologyRecord> interface --------------
