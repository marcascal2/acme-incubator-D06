...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.tool-record.form.label.activitySector" path="activitySector.sector"/>
	<acme:form-textarea code="authenticated.tool-record.form.label.inventorName" path="inventorName"/>
